...
public final class IGConfigReload {
     ...
     * NeoForge {@code AddReloadListenerEvent} — el nombre pre-26.x de
     * {@code AddServerReloadListenersEvent}), no el listener de abajo.
     *
    ...
    public static void register() {
        ReloadListenerRegistry.register(PackType.SERVER_DATA, new ResyncListener(),
                ResourceLocation.fromNamespaceAndPath(IdleGenerators.MOD_ID, "config"));
