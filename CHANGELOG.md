...
- **New generators:** Amethyst (amethyst shards), Honeycomb, Glow Lichen, Moss (moss blocks), Spore Blossom, Big Dripleaf, Flowering Azalea, Resin (resin clumps).
- Recipes follow the Colors layout: glass corners, two vines on the sides (the set's signature), a thematic ingredient top and bottom (calcite, honey bottle, bone meal, moss carpet, moss block, small dripleaf, azalea, pale oak log) and the produced item itself as the center sample.
- Three speed tiers: moss and glow lichen every 5 s (cap 512); big dripleaf and flowering azalea every 10 s and honeycomb every 15 s; amethyst and resin every 20 s (cap 512) and spore blossom, the rarest, every 30 s (cap 256).
